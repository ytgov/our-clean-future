    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            TargetCompletionDate = table.Column<DateTime>(
                                type: "datetime2",
                                nullable: true
                            ),
                            ActualCompletionDate = table.Column<DateTime>(
                                type: "datetime2",
                                nullable: true
                            ),
                            InternalStatus = table.Column<string>(
                                type: "nvarchar(max)",
                                nullable: false
                            ),
                            InternalStatusUpdatedBy = table.Column<string>(
                                type: "nvarchar(max)",
                                nullable: false
                            ),
                            InternalStatusUpdatedDate = table.Column<DateTimeOffset>(
                                type: "datetimeoffset",
                                nullable: true
                            ),
                            ExternalStatus = table.Column<string>(
                                type: "nvarchar(max)",
                                nullable: false
                            ),
                            PublicExplanation = table.Column<string>(
                                type: "nvarchar(max)",
                                nullable: false
                            ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_ActionDirectorsCommittee",
                        x => new { x.ActionsId, x.DirectorsCommitteesId }
                    );
                    table.ForeignKey(
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            CollectionInterval = table.Column<string>(
                                type: "nvarchar(max)",
                                nullable: false
                            ),
                            Note = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            OcfDescription = table.Column<string>(
                                type: "nvarchar(max)",
                                nullable: false
                            ),
                            IndicatorId = table.Column<int>(type: "int", nullable: false),
        ...
        {
            migrationBuilder.DropTable(name: "ActionDirectorsCommittee");
            ...
            migrationBuilder.DropTable(name: "GoalObjective");

            migrationBuilder.DropTable(name: "IndicatorLead");

            migrationBuilder
                .DropTable(name: "Targets")
                .Annotation("SqlServer:IsTemporal", true)
                .Annotation("SqlServer:TemporalHistoryTableName", "TargetsHistory")
                .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                .Annotation("SqlServer:TemporalPeriodEndColumnName", "ValidTo")
            ...
            migrationBuilder.DropTable(name: "DirectorsCommittees");

            migrationBuilder.DropTable(name: "Leads");

            migrationBuilder
                .DropTable(name: "Indicators")
                .Annotation("SqlServer:IsTemporal", true)
                .Annotation("SqlServer:TemporalHistoryTableName", "IndicatorsHistory")
                .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                .Annotation("SqlServer:TemporalPeriodEndColumnName", "ValidTo")
            ...
            migrationBuilder.DropTable(name: "UnitsOfMeasurement");
