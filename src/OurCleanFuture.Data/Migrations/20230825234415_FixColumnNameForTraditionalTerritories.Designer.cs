...
namespace OurCleanFuture.Data.Migrations
{
    ...
    [Migration("20230825234415_FixColumnNameForTraditionalTerritories")]
    partial class FixColumnNameForTraditionalTerritories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OurCleanFuture.Data.Entities.Action", b =>
                {
                    ...
                    b.Property<string>("EngagementsAndPartnershipActivities")
                        .IsRequired()
                        .HasMaxLength(2000)
